...
1. From the **Command Palette** in VS Code, enter the following to show the available run command options:
	...
	> [AZURE.NOTE] If the command does not appear or is not available, you may need to install the C# extension. Run ">Extensions: Install Extension" and "ext install c#" to install the C# extensions.
